import{w as s,a as d,e as r,u as c}from"./index-ef93590f.js";import{i as h,j as u,k as m}from"./lib-franklin-ecff36a3.js";import"./index-1a733ee4.js";import"./index-d475d2ea.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-356e4a49.js";import"./isEqual-d0561132.js";import"./_getTag-7cbcf524.js";import"./uniq-74fc131e.js";import"./preload-helper-41c905a7.js";const z={title:"Blocks/Header",parameters:{layout:"fullscreen"}},v=(a,e)=>{const o=document.createElement("header"),n=h("header","");return o.append(n),u(n),m(n,e.parameters.host),o},t={render:(a,e)=>v(a,e),play:async({canvasElement:a})=>{const e=s(a);await d(()=>{r(e.getByText("Rosalind")).toBeInTheDocument()});const o=document.querySelector(".logo");await d(()=>r(o).toBeInTheDocument());const n=document.querySelector(".nav-hamburger");r(n).toBeInTheDocument()}},i={parameters:{viewport:{defaultViewport:"xs"}},render:(a,e)=>v(a,e),play:async({canvasElement:a})=>{const e=s(a);await d(()=>{r(e.getByText("Rosalind")).toBeInTheDocument()});const o=document.querySelector(".nav-hamburger");r(o).toBeInTheDocument()}},l={parameters:{viewport:{defaultViewport:"xs"}},render:(a,e)=>v(a,e),play:async({canvasElement:a})=>{const e=s(a);await d(()=>{r(e.getByText("Rosalind")).toBeInTheDocument()});const o=document.querySelector(".nav-hamburger");r(o).toBeInTheDocument(),await c.click(o),r(e.getByText("Home")).toBeInTheDocument(),r(e.getByText("Tutorials")).toBeInTheDocument(),r(e.getByText("Storybook")).toBeInTheDocument()}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
...
//# sourceMappingURL=header.stories-3824686a.js.map
