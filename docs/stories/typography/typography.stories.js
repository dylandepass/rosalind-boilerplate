...
export const Demo = {
  title: 'Demo',
  render: ({ label, ...args }) =>/* html */`<div class="story">
...
export const Code = {
  title: 'Code',
  render: ({ label, ...args }) =>/* html */'<div class="story"><code>const foo = \'bar\';</code></div>',
};

export const CSSUtility = {
  title: 'CSSUtility',
  render: ({ label, ...args }) =>/* html */`<div class="story"><h1>This is an h1</h1>
...
export const FontWeightUtilities = {
  ...
  render: ({ label, ...args }) =>/* html */'<div class="story"><h3>This is an <span class="bold">h3</span></h3></div>',
};
